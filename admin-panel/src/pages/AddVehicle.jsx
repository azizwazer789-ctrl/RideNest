...
function AddVehicle() {
  ...
  return (
    <div className="min-h-screen text-white px-6 py-10">
      <div className="max-w-4xl mx-auto border border-slate-700 rounded-2xl p-8 bg-slate-900/50">
        <h1 className="text-3xl font-bold text-emerald-400 mb-2">Add Vehicle</h1>
        <p className="text-slate-400 mb-8">Add your car listing for admin approval.</p>
