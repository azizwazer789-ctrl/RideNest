    ...
    <main className="bg-slate-950 text-slate-100">
      <section className="relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=900&q=80')",
          }}
        />
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-16 sm:px-6 lg:px-8 lg:pb-24 lg:pt-24">
          <div className="max-w-3xl">
            <p className="inline-flex rounded-full border border-emerald-400/30 bg-emerald-500/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-emerald-300">
          ...
          <div className="mt-12 rounded-2xl border border-white/10 bg-slate-900/75 p-4 shadow-2xl backdrop-blur sm:p-6">
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
              <div className="lg:col-span-2">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-700 bg-slate-950/80 px-4 py-3 text-sm text-slate-100 placeholder:text-slate-500 focus:border-emerald-400 focus:outline-none"
                />
              </div>
              <div>
                <label className="mb-2 block text-xs font-medium text-slate-300">
                ...
                <input
                  type="date"
                  className="w-full rounded-lg border border-slate-700 bg-slate-950/80 px-4 py-3 text-sm text-slate-100 focus:border-emerald-400 focus:outline-none"
                />
              </div>
              <div>
                <label className="mb-2 block text-xs font-medium text-slate-300">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {categories.map((item) => (
            <article
              key={item.title}
              className="rounded-xl border border-slate-800 bg-slate-900 p-5 transition hover:border-emerald-500/50"
            >
          ...
          {featuredVehicles.map((vehicle) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="mt-3 text-sm text-slate-300">{vehicle.rate}</p>
                <Link
                  to="/vehicles"
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="rounded-xl border border-slate-800 bg-slate-900 p-5">
            ...
            <p className="mt-2 text-sm text-slate-400">Successful bookings</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900 p-5">
            <p className="text-3xl font-bold text-emerald-400">2,500+</p>
            <p className="mt-2 text-sm text-slate-400">Active vehicles</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900 p-5">
            <p className="text-3xl font-bold text-orange-400">120+</p>
            <p className="mt-2 text-sm text-slate-400">Verified vendors</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900 p-5">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="rounded-2xl border border-emerald-500/20 bg-gradient-to-r from-slate-900 via-slate-900 to-emerald-950 p-8 sm:p-10">
